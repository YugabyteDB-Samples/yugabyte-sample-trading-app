...
public interface TradeRepository extends JpaRepository<Trade, Integer> {
	...
	@Query(value="select trade_id,symbol,trade_type,to_char(bid_price,'LFM99D00') as bid_price,order_time  from trades where customer_id=:customerId AND order_time > current_timestamp - interval '30 day' order by order_time limit 30", nativeQuery=true)
